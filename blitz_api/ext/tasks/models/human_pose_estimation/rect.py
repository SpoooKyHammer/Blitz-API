...
def get_rect(images: list[str], height_size: int = 512) -> None:
    ...
    """
    net = PoseEstimationWithMobileNet()
    checkpoint = torch.load('./blitz_api/ext/tasks/models/human_pose_estimation/checkpoint_iter_370000.pth', map_location='cpu')
...
#load_state(net, checkpoint)
#image_path = "D:\\sk\\pifu_testing\\pifuhd\\sample_images\\female.jpg"
#get_rect(net.cpu(), [image_path], 512)
#print("done")
